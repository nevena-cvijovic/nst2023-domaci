...
public class SecretaryOfDepartmentHistoryDto implements Serializable {
    ...
    public SecretaryOfDepartmentHistoryDto() {
    }

    public SecretaryOfDepartmentHistoryDto(DepartmentDto departmentDto, MemberDto memberDto, LocalDate startDate, LocalDate endDate) {
